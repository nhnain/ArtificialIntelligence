...
""" % (prereq, q, q, prereq))
      ...
      try:
        util.TimeoutFunction(getattr(gradingModule, q),200)(self) # Call the question's function
  ...
  def assignCredict(self, points):
    self.points[self.currentQuestion] = points * self.maxes[self.currentQuestion]
